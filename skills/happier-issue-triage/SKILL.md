...
- **Authority:** read-only by default; GitHub write-back and repository changes require separate explicit authority. A broad request to triage, organize, update, or clean up issues does not establish authority by itself. Use the exact or bounded standing authorization defined by `skills/happier-github-ops`.
